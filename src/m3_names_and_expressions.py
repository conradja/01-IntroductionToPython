...
#       2.0 ** 100 float
#       math.sin(8) float
#       math.sin    builtin_function_or_method
...
###############################################################################
print(type(3.14))
print(type("hello"), type('hello'), type('a b c'), type(3 + 3), type("3" + "3"), type(2 **100),
    type(2.0 **100), type(math.sin(8)), type(math.sin), type(print), type(math), type('math'))
